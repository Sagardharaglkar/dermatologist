...
const SERVICES = [
  {
    ...
    desc: "Comprehensive acne management including medical-grade peels, topical therapies, and personalized skincare routines.",
...
const TESTIMONIALS = [
  {
    ...
    location: "Kudal",
    rating: 5,
    text: "Dr. Sunita's diagnosis was spot-on. She identified my skin issue immediately and the treatment worked within two weeks. I'm so relieved! Her attention to every detail made me feel completely at ease.",
    treatment: "Acne Treatment",
    initials: "PD",
  ...
  },
  {
    ...
    location: "Sindhudurg",
    rating: 5,
    text: "The staff is incredibly friendly and the treatment prices are very reasonable for the quality of care. Dr. Pawar explained everything clearly and made sure I understood my skincare routine.",
    treatment: "Pigmentation Treatment",
    initials: "RS",
  ...
  },
  {
    ...
    location: "Malvan",
    rating: 5,
    text: "I had stubborn warts for years and they were removed in just one session! The results were quick and I barely felt anything. Highly recommend Dr. Sunita to anyone with skin concerns.",
    treatment: "Wart Removal",
    initials: "MG",
  ...
  },
  {
    ...
    location: "Vengurla",
    rating: 5,
    text: "My skin allergies were causing me so much discomfort. After consulting Dr. Pawar, I finally got proper relief. Her systematic approach and follow-up care is exceptional.",
  ...
  },
  {
    ...
    location: "Sawantwadi",
    rating: 5,
    text: "The anti-aging treatment has given me such a confidence boost. My skin looks 5 years younger! Dr. Sunita's expertise and the welcoming clinic environment make every visit a pleasure.",
  ...
  },
  {
    ...
    location: "Kankavli",
    rating: 5,
    text: "Professional, knowledgeable, and genuinely caring. Dr. Pawar took time to understand my concerns before recommending treatment. Best dermatologist in Sindhudurg district without a doubt!",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. Dr. Sunita specialises in treating all skin types including sensitive and darker Indian skin tones. Every treatment plan is personalised.",
  },
  {
...
function WhatsAppBtn({ fixed = false }) {
  const base =
    "flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-full shadow-lg transition-all duration-200 active:scale-95";
  if (fixed) {
    return (
      <a
        href="https://wa.me/919999999999?text=Hello%20Dr.%20Sunita%20Pawar%2C%20I%20would%20like%20to%20book%20an%20appointment."
        target="_blank"
...
function HomePage({ setPage }) {
  ...
  const features = [
    ...
    { icon: "📍", title: "Convenient Location", desc: "Easily accessible clinic in the heart of Kudal, Sindhudurg" },
  ];
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative min-h-screen flex items-center overflow-hidden" style={{ background: "linear-gradient(135deg, #f0fdf4 0%, #fef9f0 50%, #f0f9ff 100%)" }}>
        {/* Decorative circles */}
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-10" style={{ background: "radial-gradient(circle, #a7f3d0, transparent)" }} />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-green-100 rounded-full px-4 py-2 text-sm font-medium text-green-700 mb-6 shadow-sm">
              ...
              Accepting New Patients · Tue–Thu 3–6 PM
            </div>
            <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-4" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>
              Dr. Sunita Pawar
              <span className="block text-3xl lg:text-4xl font-normal mt-1" style={{ color: "#4a7c5e" }}>Skincare Clinic</span>
            </h1>
            <p className="text-2xl font-light text-stone-500 mb-3 tracking-wide italic">"Healthy Skin Starts Here"</p>
            <p className="text-base text-stone-600 leading-relaxed mb-8 max-w-lg">
              Expert dermatological care in Kudal, Sindhudurg. Personalised treatments for every skin concern — from acne to anti-aging — delivered with compassion and clinical precision.
            </p>
            <div className="flex flex-wrap gap-4 mb-10">
              <button onClick={() => setPage("Appointment")} className="px-8 py-4 rounded-full text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200 hover:-translate-y-0.5 active:scale-95" style={{ background: "linear-gradient(135deg, #22c55e, #16a34a)" }}>
                📅 Book Appointment
              </button>
              <WhatsAppBtn />
            </div>
            <div className="flex gap-8">
              {[["500+", "Patients"], ["7+", "Treatments"], ["5★", "Ratings"]].map(([n, l]) => (
                <div key={l}>
                  <div className="text-2xl font-bold" style={{ color: "#16a34a" }}>{n}</div>
          ...
          <div className="relative flex justify-center">
            <div className="relative">
              <div className="w-72 h-80 lg:w-80 lg:h-96 rounded-3xl shadow-2xl overflow-hidden" style={{ background: "linear-gradient(145deg, #d1fae5, #a7f3d0)" }}>
                <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                  <div className="w-32 h-32 rounded-full bg-white/50 flex items-center justify-center text-6xl mb-4 shadow-inner">👩‍⚕️</div>
                  <h3 className="text-xl font-bold text-emerald-900">Dr. Sunita Pawar</h3>
                  <p className="text-emerald-700 text-sm">MD Dermatology</p>
                  <p className="text-emerald-600 text-xs mt-1">Sindhudurg's Trusted Skin Specialist</p>
                  <div className="mt-4 flex gap-1"><StarRating /></div>
                  <p className="text-xs text-emerald-700 mt-1">5.0 · 200+ reviews</p>
                </div>
              </div>
              {/* Floating badges */}
              <div className="absolute -left-6 top-8 bg-white rounded-2xl shadow-lg px-4 py-3 text-center">
                <div className="text-green-600 text-xl font-bold">7+</div>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mt-2" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>A Clinic Built on Trust & Expertise</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-stone-600 leading-relaxed mb-4">
                Dr. Sunita Pawar Skincare is Kudal's premier dermatology clinic, dedicated to providing evidence-based, compassionate skin care to patients across Sindhudurg district. Our clinic blends clinical excellence with a warm, welcoming environment.
              </p>
              <p className="text-stone-600 leading-relaxed mb-6">
                Whether you're dealing with a persistent skin condition or seeking a cosmetic enhancement, Dr. Pawar's personalised approach ensures you receive the most effective and appropriate treatment for your unique skin.
              </p>
              <button onClick={() => setPage("About")} className="inline-flex items-center gap-2 text-green-700 font-semibold hover:gap-3 transition-all">
                Meet Dr. Sunita Pawar <span>→</span>
              </button>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {features.map((f, i) => (
                <div key={i} onClick={() => setActiveFeature(i)} className={`p-5 rounded-2xl cursor-pointer transition-all duration-300 ${activeFeature === i ? "shadow-lg scale-105" : "hover:shadow-md"}`} style={{ background: activeFeature === i ? "linear-gradient(135deg, #f0fdf4, #dcfce7)" : "#f9fafb" }}>
      ...
      <section className="py-16" style={{ background: "#f8fdf8" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mt-2" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>Popular Treatments</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {SERVICES.slice(0, 6).map((s, i) => (
              <div key={i} className={`p-6 rounded-2xl bg-gradient-to-br ${s.color} border border-white/80 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer`} onClick={() => setPage("Services")}>
                ...
                <div className="mt-4 text-sm font-semibold" style={{ color: "#16a34a" }}>Learn more →</div>
              </div>
            ))}
          </div>
          <div className="text-center mt-8">
            <button onClick={() => setPage("Services")} className="px-8 py-3 border-2 border-green-600 text-green-700 rounded-full font-semibold hover:bg-green-600 hover:text-white transition-all">
              View All Services
            </button>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mt-2" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>What Our Patients Say</h2>
          </div>
          ...
          <div className="text-center mt-8">
            <button onClick={() => setPage("Reviews")} className="inline-flex items-center gap-2 text-green-700 font-semibold hover:gap-3 transition-all">
              See All Reviews →
            </button>
          </div>
        </div>
      ...
      <section className="py-16" style={{ background: "linear-gradient(135deg, #14532d, #166534)" }}>
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-green-200 mb-8">Book your consultation today. Appointments available Tuesday – Thursday, 3:00 PM – 6:00 PM.</p>
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => setPage("Appointment")} className="px-8 py-4 bg-white text-green-800 rounded-full font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all">
              📅 Book Appointment
            </button>
            <WhatsAppBtn />
          </div>
    ...
    <div className="min-h-screen bg-white">
      <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold mt-2" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>Dr. Sunita Pawar</h1>
          <p className="text-stone-500 mt-2">MD Dermatology · Skin & Cosmetology Specialist</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-16">
          ...
          <div className="sticky top-24">
            <div className="rounded-3xl overflow-hidden shadow-xl" style={{ background: "linear-gradient(145deg, #d1fae5, #a7f3d0)" }}>
              <div className="p-10 text-center">
                <div className="w-40 h-40 rounded-full bg-white/60 mx-auto flex items-center justify-center text-7xl shadow-inner mb-6">👩‍⚕️</div>
                <h2 className="text-2xl font-bold text-emerald-900 mb-1">Dr. Sunita Pawar</h2>
                <p className="text-emerald-700 font-medium">MD Dermatology</p>
                <p className="text-emerald-600 text-sm mt-1">Sindhudurg's Trusted Skin Specialist</p>
                <div className="flex justify-center mt-3"><StarRating /></div>
                <div className="mt-6 grid grid-cols-3 gap-4 text-center">
                  {[["500+", "Patients"], ["7+", "Treatments"], ["5★", "Reviews"]].map(([n, l]) => (
                    <div key={l} className="bg-white/50 rounded-2xl p-3">
                      <div className="text-xl font-bold text-emerald-800">{n}</div>
            ...
            <div className="mt-6 p-6 rounded-2xl bg-amber-50 border border-amber-100">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between"><span className="text-stone-600">Tuesday – Thursday</span><span className="font-semibold text-stone-800">3:00 PM – 6:00 PM</span></div>
                <div className="flex justify-between"><span className="text-stone-600">Friday – Monday</span><span className="font-medium text-red-500">Closed</span></div>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="mb-8">
              <h3 className="text-xl font-bold text-stone-800 mb-3 flex items-center gap-2">🎓 Qualifications</h3>
              <div className="space-y-3">
                {[
                  ["MD Dermatology", "Medical Degree in Dermatology, Venereology & Leprosy"],
                  ["MBBS", "Bachelor of Medicine and Bachelor of Surgery"],
                  ["Certified Cosmetologist", "Advanced training in cosmetic dermatology procedures"],
                  ["Member – IADVL", "Indian Association of Dermatologists, Venereologists & Leprologists"],
                ].map(([title, sub]) => (
            ...
            <div className="mb-8">
              ...
              <div className="p-5 rounded-2xl border-l-4 border-green-500 bg-green-50">
                ...
                <p className="mt-3 text-sm font-semibold text-green-700">— Dr. Sunita Pawar</p>
              </div>
            </div>
            ...
            <button onClick={() => setPage("Appointment")} className="w-full py-4 rounded-2xl text-white font-bold text-lg shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all" style={{ background: "linear-gradient(135deg, #22c55e, #16a34a)" }}>
              Book a Consultation with Dr. Pawar →
            </button>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen" style={{ background: "#f8fdf8" }}>
      <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mt-2" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>Our Dermatology Services</h1>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {SERVICES.map((s, i) => (
            <div key={i} className={`rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${selected === i ? "ring-2 ring-green-500 shadow-xl" : "shadow-md"}`} onClick={() => setSelected(selected === i ? null : i)}>
              ...
              {selected === i && (
                <div className="bg-white p-6 border-t border-stone-100">
                  ...
                  <button onClick={(e) => { e.stopPropagation(); setPage("Appointment"); }} className="w-full py-3 rounded-xl text-white font-semibold text-sm hover:opacity-90 transition-opacity" style={{ background: "linear-gradient(135deg, #22c55e, #16a34a)" }}>
        ...
        <div className="mt-16 rounded-3xl p-10 text-center" style={{ background: "linear-gradient(135deg, #14532d, #166534)" }}>
          ...
          <p className="text-green-200 mb-6">Book a General Skin Consultation and Dr. Pawar will guide you to the right treatment.</p>
          <div className="flex flex-wrap justify-center gap-4">
    ...
    <div className="min-h-screen py-16 px-4" style={{ background: "linear-gradient(135deg, #f0fdf4, #fef9f0)" }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mt-2" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>Book Your Consultation</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-green-800 rounded-2xl p-6 text-white">
              ...
              <p className="text-green-200 text-sm mb-1">Tuesday – Thursday</p>
              <p className="text-xl font-bold">3:00 PM – 6:00 PM</p>
              <p className="text-green-300 text-xs mt-2">Closed Fri – Mon</p>
            </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl shadow-xl p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="submit" disabled={loading} className="w-full py-4 rounded-2xl text-white font-bold text-lg shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all disabled:opacity-60 disabled:cursor-not-allowed" style={{ background: "linear-gradient(135deg, #22c55e, #16a34a)" }}>
    ...
    <div className="min-h-screen bg-white py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mt-2" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>Reviews & Testimonials</h1>
          <p className="text-stone-500 mt-3">Real experiences from our valued patients across Sindhudurg.</p>
          <div className="flex items-center justify-center gap-4 mt-6 p-4 bg-amber-50 rounded-2xl inline-flex mx-auto w-fit">
            <div className="text-5xl font-bold text-amber-500">5.0</div>
            <div>
              <StarRating />
              <div className="text-sm text-stone-500 mt-1">Based on 200+ patient reviews</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-10 p-6 rounded-2xl bg-blue-50 border border-blue-100 flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-stone-500">Search "Dr. Sunita Pawar Kudal" on Google Maps to see our live reviews</div>
          </div>
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button onClick={() => setPage("Appointment")} className="px-6 py-3 rounded-full font-semibold text-white hover:opacity-90 transition-opacity" style={{ background: "linear-gradient(135deg, #22c55e, #16a34a)" }}>Book Your Appointment</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen py-16 px-4" style={{ background: "#f8fdf8" }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mt-2" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>Contact & Location</h1>
          <p className="text-stone-500 mt-3">We're located in Kudal, Sindhudurg. Walk in or book ahead.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-5">
            <div className="bg-white rounded-2xl p-6 shadow-md">
              <h3 className="font-bold text-stone-800 mb-4 flex items-center gap-2">📍 Address</h3>
              <p className="text-stone-600 text-sm leading-loose">
                Nirmiti Lakshmi Narayan Apartment,<br />
                Rawoolwadi, Kudal,<br />
                Laxmi Wadi, Sindhudurg,<br />
                Maharashtra – 416520
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-green-50 rounded-xl">
                  <div>
                    <div className="font-semibold text-stone-800 text-sm">Tuesday – Thursday</div>
                    <div className="text-xs text-stone-500">3 days a week</div>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-green-700">3:00 PM – 6:00 PM</div>
                    <div className="text-xs text-green-600">Open</div>
                  </div>
                </div>
                <div className="flex justify-between items-center p-3 bg-red-50 rounded-xl">
                  <div className="font-semibold text-stone-800 text-sm">Friday – Monday</div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md">
              ...
              <div className="space-y-3">
                <a href="tel:+919999999999" className="flex items-center gap-3 p-3 rounded-xl bg-stone-50 hover:bg-stone-100 transition-colors">
                  <span className="text-2xl">📱</span>
                  <div>
                    <div className="text-xs text-stone-500">Phone / WhatsApp</div>
                    <div className="font-semibold text-stone-800 text-sm">+91 99999 99999</div>
                  </div>
                </a>
                <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-xl bg-green-50 hover:bg-green-100 transition-colors">
                  <span className="text-2xl">💬</span>
                  <div>
            ...
            <button onClick={() => setPage("Appointment")} className="w-full py-4 rounded-2xl text-white font-bold text-base shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all" style={{ background: "linear-gradient(135deg, #22c55e, #16a34a)" }}>
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-2xl overflow-hidden shadow-md">
              <div className="p-4 bg-green-50 border-b border-green-100">
                <h3 className="font-bold text-stone-800 text-sm flex items-center gap-2">🗺️ Find Us on Map — Kudal, Sindhudurg</h3>
              </div>
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30668.68505580453!2d73.68!3d16.02!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc0cd69b0b2cc79%3A0x16ee3e0e6c9e32b4!2sKudal%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin"
              />
            </div>
            <div className="bg-white rounded-2xl p-5 shadow-md">
              <h3 className="font-bold text-stone-800 mb-3 text-sm">🧭 How to Reach Us</h3>
              <div className="space-y-2 text-sm text-stone-600">
                <div className="flex items-start gap-2"><span>🚗</span><span><strong>By Car:</strong> Nirmiti Lakshmi Narayan Apartment, Rawoolwadi, Kudal. Search on Google Maps for easy navigation.</span></div>
                <div className="flex items-start gap-2"><span>🚌</span><span><strong>By Bus:</strong> Alight at Kudal Bus Stand, auto-rickshaws available to Rawoolwadi.</span></div>
                <div className="flex items-start gap-2"><span>🏙️</span><span><strong>Landmark:</strong> Laxmi Wadi area, Sindhudurg District.</span></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen py-16 px-4" style={{ background: "linear-gradient(180deg, #f8fdf8 0%, #fff 100%)" }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-4">
          ...
          <h1 className="text-4xl font-bold mt-2" style={{ fontFamily: "'Georgia', serif", color: "#1a3c2e" }}>Treatment Results</h1>
          <p className="text-stone-500 mt-3 max-w-xl mx-auto text-sm leading-relaxed">
            Each card below is a placeholder ready for a real patient photo. Simply replace the placeholder with actual before/after images when available.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4 p-4 rounded-2xl bg-amber-50 border border-amber-200">
            ...
            <div>
              ...
              <div className="text-amber-700 text-xs mt-1 leading-relaxed">
                Place your patient images in <code className="bg-amber-100 px-1 rounded">public/gallery/</code> folder and update the <code className="bg-amber-100 px-1 rounded">src</code> prop on each card. Always obtain written patient consent before publishing. See comments in code.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-10">
          {tabs.map(tab => (
            <button
              ...
              style={activeTab === tab ? { background: "linear-gradient(135deg, #22c55e, #16a34a)" } : {}}
            >
                ...
                {group.cases.map((c, idx) => (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 h-44 relative">
                      {/* BEFORE placeholder */}
                      <div
                        className={`flex flex-col items-center justify-center gap-1 bg-gradient-to-br ${group.color} relative`}
                        onMouseEnter={() => setUploadHover(`${c.id}-before`)}
                        onMouseLeave={() => setUploadHover(null)}
                      >
                        {/* Replace this div with: <img src="/gallery/your-image.jpg" className="w-full h-full object-cover" alt="Before" /> */}
                      ...
                      {/* AFTER placeholder */}
                      <div
                        className="flex flex-col items-center justify-center gap-1 bg-white relative border-l border-stone-100"
                        onMouseEnter={() => setUploadHover(`${c.id}-after`)}
                        onMouseLeave={() => setUploadHover(null)}
                      >
                        {/* Replace this div with: <img src="/gallery/your-image-after.jpg" className="w-full h-full object-cover" alt="After" /> */}
                        <div className="text-3xl opacity-40">🌟</div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex flex-wrap gap-2 text-xs text-stone-500">
                        ...
                        <span className="flex items-center gap-1">🔁 {c.sessions}</span>
                        <span className="flex items-center gap-1">👤 {c.patientAge}</span>
                      </div>
                      ...
                      {selectedCard === c.id && (
                        <div className="mt-3 pt-3 border-t border-stone-100 space-y-2">
                          <div className="text-xs text-stone-500 leading-relaxed">
                            <strong className="text-stone-700">Treatment duration:</strong> {c.duration} with {c.sessions}.
                          </div>
                          <div className="flex gap-2">
                            ...
                            <div className="flex-1 p-2 rounded-lg text-xs bg-green-50 text-green-800">
                              <div className="font-bold mb-0.5">After</div>
                              {c.afterNote}
                            </div>
                          </div>
                          <button
                            onClick={(e) => { e.stopPropagation(); setPage("Appointment"); }}
                            className="w-full mt-1 py-2 rounded-xl text-white text-xs font-bold transition-opacity hover:opacity-90"
        ...
        <div className="mt-14 p-6 rounded-2xl bg-stone-50 border border-stone-200 flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="text-stone-500 text-xs leading-relaxed">
              All real patient photos must be published only with documented written consent as per Indian Medical Council guidelines. Names and identifying information should be anonymised unless explicit permission is granted. Placeholder cards are shown above — replace with actual photos once consent is obtained.
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 rounded-3xl p-10 text-center" style={{ background: "linear-gradient(135deg, #14532d, #166534)" }}>
          ...
          <p className="text-green-200 text-sm mb-6">Book a consultation and start your skin transformation journey with Dr. Sunita Pawar.</p>
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => setPage("Appointment")} className="px-8 py-3 bg-white text-green-800 rounded-full font-bold hover:shadow-lg transition-all">📅 Book Consultation</button>
            <WhatsAppBtn />
          </div>
    ...
    <footer style={{ background: "#0d2818" }} className="text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="font-bold text-lg" style={{ fontFamily: "'Georgia', serif" }}>Dr. Sunita Pawar</div>
                <div className="text-green-400 text-xs">Skincare Clinic · Kudal, Sindhudurg</div>
              </div>
            </div>
            <p className="text-stone-400 text-sm leading-relaxed mb-4 max-w-sm">"Healthy Skin Starts Here" — Expert dermatological care with a personal touch for patients across Sindhudurg.</p>
            <div className="flex gap-2">
              <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-green-600 hover:bg-green-500 rounded-lg text-xs font-semibold transition-colors">WhatsApp</a>
              <a href="tel:+919999999999" className="px-4 py-2 bg-stone-700 hover:bg-stone-600 rounded-lg text-xs font-semibold transition-colors">Call Us</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-stone-400">
              <div>📍 Rawoolwadi, Kudal</div>
              <div>📍 Sindhudurg – 416520</div>
              <div>⏰ Tue–Thu: 3–6 PM</div>
        ...
        <div className="border-t border-stone-700 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-stone-500">© 2025 Dr. Sunita Pawar Skincare. All rights reserved.</p>
          <p className="text-xs text-stone-600">Serving Kudal, Sindhudurg, Malvan & surrounding areas</p>
        </div>
      </div>
    </footer>
  );
...
export default function App() {
  ...
  const pages = { Home: <HomePage setPage={navigate} />, About: <AboutPage setPage={navigate} />, Services: <ServicesPage setPage={navigate} />, Gallery: <GalleryPage setPage={navigate} />, Appointment: <AppointmentPage />, Reviews: <ReviewsPage setPage={navigate} />, Contact: <ContactPage setPage={navigate} /> };
      ...
      <nav className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm shadow-sm border-b border-stone-100">
          ...
          <div className="flex items-center justify-between h-16">
            <button onClick={() => navigate("Home")} className="flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="font-bold text-stone-800 text-sm leading-tight" style={{ fontFamily: "'Georgia', serif" }}>Dr. Sunita Pawar</div>
                <div className="text-xs text-green-600">Skincare Clinic · Kudal</div>
              </div>
            </button>
            ...
            <div className="hidden md:flex items-center gap-1">
              {NAV_LINKS.map(l => (
                <button key={l} onClick={() => navigate(l)} className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${page === l ? "bg-green-100 text-green-700" : "text-stone-600 hover:text-green-700 hover:bg-green-50"}`}>{l}</button>
              ))}
              <button onClick={() => navigate("Appointment")} className="ml-2 px-5 py-2 rounded-full text-white text-sm font-semibold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all" style={{ background: "linear-gradient(135deg, #22c55e, #16a34a)" }}>
                Book Now
              </button>
            </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-stone-100 px-4 py-3 space-y-1">
            {NAV_LINKS.map(l => (
              <button key={l} onClick={() => navigate(l)} className={`w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-all ${page === l ? "bg-green-100 text-green-700" : "text-stone-600 hover:bg-stone-50"}`}>{l}</button>
            ))}
            <div className="pt-2 pb-1">
              <button onClick={() => navigate("Appointment")} className="w-full py-3 rounded-xl text-white font-semibold text-sm" style={{ background: "linear-gradient(135deg, #22c55e, #16a34a)" }}>
                📅 Book Appointment
              </button>
            </div>
          </div>
